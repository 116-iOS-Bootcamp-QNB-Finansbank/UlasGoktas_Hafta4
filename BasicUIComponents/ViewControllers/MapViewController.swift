...
class MapViewController: UIViewController {
    ...
    private func checkLocaionStatus() {
        ...
        case .denied, .restricted:
            performSegue(withIdentifier: K.locationSegue, sender: nil)
        // Odev 2 burada settings'e yonlendirmek uzere bir popup gosterip. popup action'inda settingsi actiralim.
        case .notDetermined:
